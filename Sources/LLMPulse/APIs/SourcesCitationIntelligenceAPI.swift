//
// SourcesCitationIntelligenceAPI.swift
//
...
open class SourcesCitationIntelligenceAPI {
     ...
     */
    public enum BrandKind_getMentionsByCitingDomain: String, Sendable, CaseIterable {
        case brand = "brand"
