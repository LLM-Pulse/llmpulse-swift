...
open class LLMPulseAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://api.llmpulse.ai/api/v1",
    ...
    public static let shared = LLMPulseAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: LLMPulseAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: LLMPulseAPIConfiguration = LLMPulseAPIConfiguration.shared
    ) {
        self.method = method
