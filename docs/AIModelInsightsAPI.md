...
```swift
    open class func getAiModelInsightsSummary(projectId: Int, range: Int? = nil, from: Date? = nil, to: Date? = nil, granularity: Granularity_getAiModelInsightsSummary? = nil, collectionId: Int? = nil, countryCode: String? = nil, languageCode: String? = nil, promptType: PromptType_getAiModelInsightsSummary? = nil, brandKind: BrandKind_getAiModelInsightsSummary? = nil, competitors: String? = nil, completion: @escaping (_ data: Void?, _ error: Error?) -> Void)
```
